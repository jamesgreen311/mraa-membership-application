   ...
   return {
      appsettings: {
         ...
         schema: {
            ...
            //membershiptypelist: "c2:c", // moved to Membership Master
            statuslist: "d2:d",
            ...
            //imagerequirements: "j2:k3", // moved to Membership Jury spreadsheet
            dues: "i2", // move to Membership master spreadsheet TODO
         },
      },
   }
}
