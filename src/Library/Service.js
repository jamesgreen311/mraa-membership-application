...
function sendConfirmation(applicant) {
   ...
   const htmlBody = `<p>We have received your application for membership in MRAA. Please review the attached document for any errors.</p>
...
function sendNotification(applicant) {
   ...
   const sendTo =
      releaseMode === "alpha" ? testEmail : appSettings.distributionlist
